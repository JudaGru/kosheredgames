...
interface HolidayMatchIllustrationProps {
  width: number;
  height: number;
  primaryColor?: string;
...
export function HolidayMatchIllustration({
  width,
  height,
  primaryColor = '#7c3aed',
  secondaryColor = '#8b5cf6',
  accentColor = '#fde047',
}: HolidayMatchIllustrationProps) {
  // Holiday colors from the game
  const holidayColors = [
    '#dc2626', '#f8fafc', '#22c55e', '#8b5cf6',
    '#0ea5e9', '#ec4899', '#7c3aed', '#10b981',
    '#64748b', '#84cc16', '#f97316', '#eab308'
  ];

  return (
    <Svg width={width} height={height} viewBox="0 0 220 140" preserveAspectRatio="xMidYMid slice">
      <Defs>
        <LinearGradient id="holidayBg" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      {/* Background gradient */}
      <Rect x="0" y="0" width="220" height="140" fill="url(#holidayBg)" />
      ...
      {/* Holiday indicator circles at top - arranged in arc */}
      {holidayColors.map((color, i) => {
      ...
      <G transform="translate(22, 35)">
        ...
        <Rect x="4" y="4" width="40" height="32" rx="4" fill="#e0f2fe" />
        <SvgText x="24" y="28" fontSize="20" textAnchor="middle">🕎</SvgText>
        <SvgText x="24" y="50" fontSize="8" fontWeight="bold" fill="#0ea5e9" textAnchor="middle">Chanukah</SvgText>
      </G>

      {/* Card 2 - Chanukah - matching! with glow */}
      ...
      {/* Card 4 - Small preview card (Purim) floating */}
      <G transform="translate(188, 45) rotate(8)">
        ...
        <Rect x="5" y="26" width="18" height="4" rx="2" fill="#ec4899" opacity="0.6" />
      </G>

      {/* Title banner at bottom */}
      <G transform="translate(110, 118)">
        {/* Banner background */}
        <Rect x="-50" y="-12" width="100" height="24" rx="12" fill="white" opacity="0.95" />
        {/* Title text */}
...
export default HolidayMatchIllustration;
