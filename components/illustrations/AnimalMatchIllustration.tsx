...
interface AnimalMatchIllustrationProps {
  width: number;
  height: number;
  primaryColor?: string;
...
export function AnimalMatchIllustration({
  width,
  height,
  primaryColor = '#f59e0b',
  secondaryColor = '#fbbf24',
  accentColor = '#fde047',
}: AnimalMatchIllustrationProps) {
  // Animal colors from the game
  const animalColors = [
    '#f59e0b', '#8b5cf6', '#ec4899', '#64748b',
    '#92400e', '#1e293b', '#dc2626', '#0ea5e9',
    '#14b8a6', '#f472b6', '#78716c', '#22c55e'
  ];

  return (
    <Svg width={width} height={height} viewBox="0 0 220 140" preserveAspectRatio="xMidYMid slice">
      <Defs>
        <LinearGradient id="animalBg" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      {/* Background gradient */}
      <Rect x="0" y="0" width="220" height="140" fill="url(#animalBg)" />
      ...
      {/* Animal indicator circles at top - arranged in arc */}
      {animalColors.map((color, i) => {
      ...
      <G transform="translate(22, 35)">
        ...
        <Rect x="4" y="4" width="40" height="32" rx="4" fill="#ede9fe" />
        <SvgText x="24" y="28" fontSize="20" textAnchor="middle">🐕</SvgText>
        <SvgText x="24" y="50" fontSize="9" fontWeight="bold" fill="#8b5cf6" textAnchor="middle">כֶּלֶב</SvgText>
      </G>

      {/* Card 2 - Dog - matching! with glow */}
      ...
      <G transform="translate(134, 35)">
        ...
        <SvgText x="24" y="38" fontSize="16" textAnchor="middle" fill="white" opacity="0.9">🐾</SvgText>
      </G>

      {/* Card 4 - Small preview card (Cat) floating */}
      <G transform="translate(188, 45) rotate(8)">
        ...
        <SvgText x="14" y="18" fontSize="14" textAnchor="middle">🐱</SvgText>
        <SvgText x="14" y="30" fontSize="7" fontWeight="bold" fill="#ec4899" textAnchor="middle">חָתוּל</SvgText>
      </G>
...
export default AnimalMatchIllustration;
