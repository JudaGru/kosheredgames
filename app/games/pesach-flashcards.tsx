...
const QUESTION_DATA = [
  {
    id: 1,
    question: 'How many cups of wine do we drink at the Seder?',
    answer: 'Four cups (Arba Kosos)',
    source: 'Shulchan Aruch OC 472',
  },
  {
    id: 2,
    question: 'What are the three matzos on the Seder table called?',
    answer: 'Kohen, Levi, and Yisroel',
    source: 'Pesach Haggadah',
  },
  {
    id: 3,
    question: 'Which item on the Seder plate represents the Korban Pesach?',
    answer: 'The zeroa (shankbone)',
    source: 'Shulchan Aruch OC 473',
  },
  {
    id: 4,
    question: 'What does the word "Pesach" mean?',
    answer: 'To pass over - Hashem passed over Jewish homes during Makkas Bechoros',
    source: 'Shemos 12:27',
  },
  {
    id: 5,
    question: 'How long did Bnei Yisroel live in Mitzrayim?',
    answer: '210 years',
    source: 'Rashi on Shemos 12:40',
  },
  {
    id: 6,
    question: 'What do we eat to remember the mortar the Jews used as slaves?',
    answer: 'Charoses',
    source: 'Pesachim 116a',
  },
  {
    id: 7,
    question: 'Why do we eat maror (bitter herbs)?',
    answer: 'To remember the bitter slavery in Egypt',
    source: 'Shemos 1:14',
  },
  {
    id: 8,
    question: 'What is the name of the middle matzah that we break and hide?',
    answer: 'Afikoman',
    source: 'Pesachim 119b',
  },
  {
    id: 9,
    question: 'Which Navi do we open the door for during the Seder?',
    answer: 'Eliyahu HaNavi',
    source: 'Minhag',
  },
  {
    id: 10,
  ...
  {
    id: 11,
    question: 'Why do we lean to the left during the Seder?',
    answer: 'To show we are free people, like royalty',
    source: 'Pesachim 108a',
  },
  {
    id: 12,
    question: 'What miracle happened at Krias Yam Suf?',
    answer: 'The sea split into 12 paths for the 12 tribes',
    source: 'Midrash Tehillim 136',
  },
  {
    id: 13,
    question: 'What is the egg on the Seder plate called and what does it represent?',
    answer: 'Beitzah - it represents the Korban Chagigah',
    source: 'Shulchan Aruch OC 473',
  },
  {
    id: 14,
    question: 'How many questions are in "Mah Nishtanah"?',
    answer: 'Four questions',
    source: 'Pesach Haggadah',
  },
  {
    id: 15,
    question: 'What do we say at the end of the Seder expressing our hope?',
    answer: 'L\'shanah Haba\'ah B\'Yerushalayim - Next year in Jerusalem!',
    source: 'Pesach Haggadah',
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          You completed all the Pesach questions!
        </Text>
...
export default function PesachFlashcardsGame() {
  const isWeb = Platform.OS === 'web';
