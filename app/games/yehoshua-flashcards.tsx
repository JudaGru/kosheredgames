...
// Sefer Yehoshua trivia questions
const QUESTION_DATA = [
  {
    id: 1,
    question: 'Who was Yehoshua\'s teacher and predecessor?',
    answer: 'Moshe Rabbeinu',
    source: 'Yehoshua 1:1',
  },
  {
    id: 2,
    question: 'What did Hashem tell Yehoshua to do constantly to succeed?',
    answer: 'Study the Torah day and night and follow all its laws',
    source: 'Yehoshua 1:8',
  },
  {
    id: 3,
    question: 'Who were the two spies Yehoshua sent to Yericho?',
    answer: 'Calev and Pinchas (according to the Midrash)',
    source: 'Yehoshua 2:1, Midrash',
  },
  {
    id: 4,
    question: 'Who hid the spies in Yericho?',
    answer: 'Rachav',
    source: 'Yehoshua 2:4',
  },
  {
    id: 5,
    question: 'What sign did Rachav use to save her family?',
    answer: 'A red cord (tikvah) tied to her window',
    source: 'Yehoshua 2:18',
  },
  {
    id: 6,
    question: 'What miracle happened when Bnei Yisroel crossed the Yarden River?',
    answer: 'The water split and stood in a heap, like Krias Yam Suf',
    source: 'Yehoshua 3:16',
  },
  {
    id: 7,
    question: 'How many stones were taken from the Yarden as a memorial?',
    answer: 'Twelve stones, one for each tribe',
    source: 'Yehoshua 4:3',
  },
  {
    id: 8,
    question: 'How many times did Bnei Yisroel march around Yericho on the seventh day?',
    answer: 'Seven times',
    source: 'Yehoshua 6:15',
  },
  {
    id: 9,
    question: 'What happened to the walls of Yericho?',
    answer: 'They fell down flat when the people shouted and the shofars blew',
    source: 'Yehoshua 6:20',
  },
  {
    id: 10,
    question: 'Who sinned by taking from the cherem (forbidden items) of Yericho?',
    answer: 'Achan ben Carmi',
    source: 'Yehoshua 7:1',
  },
  {
    id: 11,
    question: 'Why did Bnei Yisroel initially lose the battle of Ai?',
    answer: 'Because of Achan\'s sin with the cherem',
    source: 'Yehoshua 7:11-12',
  },
  {
    id: 12,
    question: 'Which nation tricked Yehoshua into making a peace treaty?',
    answer: 'The Givonim (Gibeonites)',
    source: 'Yehoshua 9:3-15',
  },
  {
    id: 13,
    question: 'What miracle did Yehoshua request during the battle against the five kings?',
    answer: 'He commanded the sun and moon to stand still',
    source: 'Yehoshua 10:12-13',
  },
  {
    id: 14,
    question: 'How long did Yehoshua lead Bnei Yisroel in conquering the land?',
    answer: 'Seven years of conquest (14 years total including division of land)',
    source: 'Yehoshua 14:10, Rashi',
  },
  {
    id: 15,
    question: 'What famous statement did Yehoshua make at the end of his life?',
    answer: 'Choose today whom you will serve... as for me and my house, we will serve Hashem',
    source: 'Yehoshua 24:15',
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          You completed all the Sefer Yehoshua questions!
        </Text>
...
export default function YehoshuaFlashcardsGame() {
  const isWeb = Platform.OS === 'web';
