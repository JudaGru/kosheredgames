...
// Parshas Noach trivia questions
const QUESTION_DATA = [
  {
    id: 1,
    question: 'Why did Hashem decide to bring a flood?',
    answer: 'The world was filled with corruption (chamas) and evil',
    source: 'Bereishis 6:11-13',
  },
  {
    id: 2,
    question: 'How long did it take Noach to build the Teiva (ark)?',
    answer: '120 years',
    source: 'Bereishis 6:3, Rashi',
  },
  {
    id: 3,
    question: 'What were the dimensions of the Teiva?',
    answer: '300 amos long, 50 amos wide, 30 amos tall',
    source: 'Bereishis 6:15',
  },
  {
    id: 4,
    question: 'How many floors did the Teiva have?',
    answer: 'Three floors',
    source: 'Bereishis 6:16',
  },
  {
    id: 5,
    question: 'How many of each kosher animal entered the Teiva?',
    answer: 'Seven pairs (14 total)',
    source: 'Bereishis 7:2',
  },
  {
    id: 6,
    question: 'How many of each non-kosher animal entered the Teiva?',
    answer: 'One pair (2 total)',
    source: 'Bereishis 7:2',
  },
  {
    id: 7,
    question: 'How long did it rain during the Mabul (flood)?',
    answer: '40 days and 40 nights',
    source: 'Bereishis 7:12',
  },
  {
    id: 8,
    question: 'What bird did Noach first send out to check if the waters receded?',
    answer: 'A raven (orev)',
    source: 'Bereishis 8:7',
  },
  {
    id: 9,
    question: 'What did the dove bring back the second time it was sent?',
    answer: 'An olive leaf (aleh zayis)',
    source: 'Bereishis 8:11',
  },
  {
    id: 10,
    question: 'On which mountain did the Teiva rest?',
    answer: 'Mount Ararat (Harei Ararat)',
    source: 'Bereishis 8:4',
  },
  {
    id: 11,
    question: 'What was the sign of Hashem\'s promise never to flood the world again?',
    answer: 'The rainbow (keshet)',
    source: 'Bereishis 9:13',
  },
  {
    id: 12,
    question: 'What did Noach do after leaving the Teiva?',
    answer: 'He built a Mizbeiach (altar) and brought korbanos',
    source: 'Bereishis 8:20',
  },
  {
    id: 13,
    question: 'Who were the three sons of Noach?',
    answer: 'Shem, Cham, and Yefes',
    source: 'Bereishis 6:10',
  },
  {
    id: 14,
    question: 'What did the generation of the Migdal Bavel (Tower of Babel) try to do?',
    answer: 'Build a tower reaching to heaven to make a name for themselves',
    source: 'Bereishis 11:4',
  },
  {
    id: 15,
    question: 'How did Hashem stop the building of the Migdal Bavel?',
    answer: 'He confused their languages so they couldn\'t understand each other',
    source: 'Bereishis 11:7-9',
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          You completed all the Parshas Noach questions!
        </Text>
...
export default function NoachFlashcardsGame() {
  const isWeb = Platform.OS === 'web';
