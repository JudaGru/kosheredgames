...
const CHARACTERS: Character[] = [
  {
    ...
    emoji: '⚔️',
    clues: [
      'I was the devoted student of Moshe.',
      'I was one of the two spies who gave a good report.',
      'I led the Jewish people across the Yarden.',
      'I conquered Yericho with the blast of shofaros.',
      'I divided the Land of Israel among the tribes.',
    ],
  },
  {
    name: 'Shmuel',
    ...
    emoji: '📯',
    clues: [
      'My mother prayed for me at the Mishkan.',
      'I was dedicated to serve Hashem from a young age.',
      'I anointed the first king of Israel.',
      'I was both a prophet and a judge.',
      'I also anointed David as king.',
    ],
  },
  {
    name: 'Eliyahu',
    ...
    emoji: '🔥',
    clues: [
      'I challenged the prophets of Baal.',
      'I was fed by ravens during a famine.',
      'I ran faster than Achav\'s chariot.',
      'I was taken up to heaven alive.',
      'I will announce the coming of Moshiach.',
    ],
  },
  {
    name: 'Yonah',
    ...
    emoji: '🐋',
    clues: [
      'I tried to run away from my mission.',
      'I boarded a ship to Tarshish.',
      'A great storm arose because of me.',
      'I was swallowed by a large fish.',
      'I prophesied to the people of Ninveh.',
    ],
  },
  {
    name: 'Ruth',
    ...
    emoji: '🌾',
    clues: [
      'I was originally from Moav.',
      'I told my mother-in-law: "Your people are my people."',
      'I gathered grain in the fields of Beis Lechem.',
      'I married Boaz.',
  ...
  },
  {
    ...
    emoji: '🦁',
    clues: [
      'I was exiled to Bavel as a young man.',
      'I refused to eat the king\'s food.',
      'I interpreted Nevuchadnezzar\'s dreams.',
      'I prayed facing Yerushalayim three times daily.',
  ...
  },
  {
    ...
    emoji: '👔',
    clues: [
      'I raised my young cousin as my own.',
      'I sat at the king\'s gate.',
      'I overheard a plot against the king.',
      'I refused to bow to Haman.',
      'I became second to King Achashverosh.',
    ],
  },
  {
    name: 'Devorah',
    ...
    clues: [
      ...
      'I was one of the seven prophetesses.',
      'I judged the Jewish people.',
      'I summoned Barak to fight Sisera.',
      'I sang a song of victory.',
    ],
  },
  {
    name: 'Shimshon',
    ...
    emoji: '💪',
    clues: [
      'I was a Nazir from birth.',
      'I was from the tribe of Dan.',
      'My strength came from Hashem.',
      'I fought against the Plishtim alone.',
      'I brought down the temple of Dagon.',
    ],
  },
  {
    name: 'Yeshayahu',
    ...
    emoji: '📜',
    clues: [
      'I saw a vision of Hashem\'s throne.',
      'I prophesied during the reign of four kings.',
      'I comforted the Jewish people about the future.',
      'I spoke about the suffering servant.',
      'My book contains 66 chapters.',
    ],
  },
];
    ...
    >
      ...
      >
        ...
        <Text style={{ color: '#64748b', textAlign: 'center', marginTop: 12, fontSize: 16 }}>
          You identified Nach personalities!
        </Text>
        ...
        <Animated.View entering={FadeIn.duration(400).delay(500)} style={{ marginTop: 28, width: '100%' }}>
          ...
          >
            <Text style={{ fontSize: 48, fontWeight: 'bold', color: '#4f46e5' }}>
              {score}/{total}
            </Text>
            <Text
              style={{
            ...
            <Text style={{ fontSize: 22, fontWeight: 'bold', color: '#6366f1', marginTop: 8 }}>
              {percentage}%
            </Text>
          </View>
        </Animated.View>
...
export default function NachWhoAmIGame() {
  const isWeb = Platform.OS === 'web';
