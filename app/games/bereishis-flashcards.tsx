...
// Parshas Bereishis trivia questions
const QUESTION_DATA = [
  {
    id: 1,
    question: 'What was the first thing Hashem created?',
    answer: 'Heaven and Earth (Shamayim and Aretz)',
    source: 'Bereishis 1:1',
  },
  {
    id: 2,
  ...
  {
    id: 3,
    question: 'What separated the upper waters from the lower waters?',
    answer: 'The Rakia (firmament/sky)',
    source: 'Bereishis 1:6-8',
  },
  {
    id: 4,
    question: 'On which day were the sun, moon, and stars created?',
    answer: 'The fourth day',
    source: 'Bereishis 1:14-19',
  },
  {
    id: 5,
    question: 'What was created on the fifth day?',
    answer: 'Fish and birds',
    source: 'Bereishis 1:20-23',
  },
  {
    id: 6,
    question: 'In whose image was Adam created?',
    answer: "In the image of Hashem (B'tzelem Elokim)",
    source: 'Bereishis 1:27',
  },
  {
    id: 7,
    question: 'What did Hashem do on the seventh day?',
    answer: 'He rested (Shabbos)',
    source: 'Bereishis 2:2-3',
  },
  {
    id: 8,
    question: 'From what was Adam created?',
    answer: 'From the dust of the ground (Afar min ha-adama)',
    source: 'Bereishis 2:7',
  },
  {
    id: 9,
    question: 'What were the two special trees in Gan Eden?',
    answer: 'The Tree of Life and the Tree of Knowledge of Good and Evil',
    source: 'Bereishis 2:9',
  },
  {
    id: 10,
    question: 'From which part of Adam was Chava created?',
    answer: 'From his rib (tzela)',
    source: 'Bereishis 2:21-22',
  },
  {
    id: 11,
    question: 'Which animal tricked Chava into eating from the forbidden tree?',
    answer: 'The nachash (serpent)',
    source: 'Bereishis 3:1-6',
  },
  {
    id: 12,
    question: "What was Adam's punishment for eating from the tree?",
    answer: 'He would have to work hard for his food and eventually return to dust',
    source: 'Bereishis 3:17-19',
  },
  {
    id: 13,
    question: 'Who were the first two children of Adam and Chava?',
    answer: 'Kayin and Hevel',
    source: 'Bereishis 4:1-2',
  },
  {
    id: 14,
    question: 'What were the occupations of Kayin and Hevel?',
    answer: 'Kayin was a farmer, Hevel was a shepherd',
    source: 'Bereishis 4:2',
  },
  {
    id: 15,
    question: "Why was Hevel's korban accepted over Kayin's?",
    answer: 'Hevel brought the best of his flock, while Kayin brought inferior produce',
    source: 'Bereishis 4:3-5',
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          You completed all the Parshas Bereishis questions!
        </Text>
...
export default function BereishisFlashcardsGame() {
  const isWeb = Platform.OS === 'web';
