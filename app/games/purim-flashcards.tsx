...
// Purim trivia questions
const QUESTION_DATA = [
  {
    id: 1,
    question: 'Who was the king in the Purim story?',
    answer: 'Achashverosh (Ahasuerus)',
    source: 'Megillas Esther 1:1',
  },
  {
    id: 2,
    question: 'What was the name of the evil villain who wanted to destroy the Jews?',
    answer: 'Haman',
    source: 'Megillas Esther 3:1',
  },
  {
    id: 3,
    question: 'Who was the Jewish queen who saved her people?',
    answer: 'Esther (Hadassah)',
    source: 'Megillas Esther 2:7',
  },
  {
    id: 4,
  ...
  {
    id: 5,
    question: 'What are the four mitzvos of Purim?',
    answer: 'Megillah, Mishloach Manos, Matanos L\'evyonim, Seudah',
    source: 'Shulchan Aruch OC 695-696',
  },
  {
    id: 6,
    question: 'What do we eat that is shaped like Haman\'s ears or hat?',
    answer: 'Hamantaschen (Oznei Haman)',
    source: 'Purim Minhag',
  },
  {
    id: 7,
    question: 'How many times is the Megillah read on Purim?',
    answer: 'Twice - once at night and once during the day',
    source: 'Shulchan Aruch OC 687',
  },
  {
    id: 8,
    question: 'What noise do we make when Haman\'s name is read?',
    answer: 'We shake graggers (ra\'ashanim) and stomp to drown out his name',
    source: 'Rema OC 690:17',
  },
  {
    id: 9,
    question: 'Why did Esther initially not want to go to the king?',
    answer: 'Anyone who approached the king without being summoned could be put to death',
    source: 'Megillas Esther 4:11',
  },
  {
    id: 10,
    question: 'What did Mordechai refuse to do that angered Haman?',
    answer: 'Bow down to him',
    source: 'Megillas Esther 3:2',
  },
  {
    id: 11,
    question: 'What happened to Haman in the end?',
    answer: 'He was hanged on the same gallows he prepared for Mordechai',
    source: 'Megillas Esther 7:10',
  },
  {
    id: 12,
    question: 'What does the word "Purim" mean?',
    answer: 'Lots - Haman cast lots (pur) to choose the day to destroy the Jews',
    source: 'Megillas Esther 9:26',
  },
  {
    id: 13,
    question: 'What special fast is observed before Purim?',
    answer: 'Taanis Esther - the Fast of Esther',
    source: 'Shulchan Aruch OC 686',
  },
  {
    id: 14,
    question: 'In which Persian city did the Purim story take place?',
    answer: 'Shushan (Susa)',
    source: 'Megillas Esther 1:2',
  },
  {
    id: 15,
    question: 'What did Esther request before going to the king?',
    answer: 'That all the Jews fast for three days',
    source: 'Megillas Esther 4:16',
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          You completed all the Purim questions!
        </Text>
...
export default function PurimFlashcardsGame() {
  const isWeb = Platform.OS === 'web';
