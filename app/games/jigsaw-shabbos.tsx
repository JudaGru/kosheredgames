        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <View style={{ flexDirection: 'row', gap: 8 }}>
            ...
            >
              ...
              <Text style={{ fontSize: 9, color: '#6d28d9', fontWeight: '600', textTransform: 'uppercase' }}>
                Time
              </Text>
            </View>
            <View
            ...
            >
              ...
              <Text style={{ fontSize: 9, color: '#7c3aed', fontWeight: '600', textTransform: 'uppercase' }}>
                Moves
              </Text>
            </View>
          </View>
...
export default function JigsawShabbosGame() {
  ...
  const refreshButtonStyle = useAnimatedStyle(() => ({
    ...
    backgroundColor: refreshButtonBg.value === 1 ? '#ede9fe' : '#faf5ff',
  }));
